...
class TestArmyList(unittest.TestCase):
    ...
    def test_new_army_list(self):
        ...
        self.assertEqual(new_list.root.entry_id, new_list.cursor_info.entry_id)
        ...
        self.assertIsNot(new_list.cursor_info.entry_id, None)
        self.assertNotEqual(new_list.cursor_info.entry_id, new_list.root.entry_id)
        self.assertGreaterEqual(new_list.add_item_by_id("1"), 0)
        new_list.move_cursor("1")
        # breakpoint()
        self.assertNotIsInstance(new_list.cursor_info, EmptyListEntry)
